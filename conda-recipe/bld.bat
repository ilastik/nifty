...
git apply -v --unsafe-paths ../conda-recipe/patches/xtensor-copysign.patch
rem make sure that the patch was applied successfully
if %errorlevel% neq 0 exit /b %errorlevel%
git apply -v --unsafe-paths ../conda-recipe/patches/xtensor-size_t.patch
rem make sure that the patch was applied successfully
if %errorlevel% neq 0 exit /b %errorlevel%
